...
export const linkPages = mysqlTable("link_pages", {
  ...
  photoSize: varchar("photoSize", { length: 20 }).default("md"),
  photoShape: varchar("photoShape", { length: 20 }).default("circle"),
  backgroundType: varchar("backgroundType", { length: 20 }).default("solid"),
  backgroundGradient: varchar("backgroundGradient", { length: 200 }),
  buttonStyle: varchar("buttonStyle", { length: 30 }).default("rounded"),
  buttonBg: varchar("buttonBg", { length: 20 }),
  buttonTextColor: varchar("buttonTextColor", { length: 20 }).default("#ffffff"),
  fontFamily: varchar("fontFamily", { length: 50 }).default("inter"),
